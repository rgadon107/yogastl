	...
	grunt.initConfig({
		...
		*/
		...
		sass: {
			dist: {
				options: {
					style: 'expanded',  //default: nested; value: string
					lineNumbers: true,  //default: false; value: boolean (false/true)
					debugInfo: true,	//default: false; value: boolean
					compass: false,		//default: false; value: boolean
					'sourcemap=auto': true	//default: 'sourcemap=auto'; value: string
				},
				files: {
